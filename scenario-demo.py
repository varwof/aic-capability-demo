    ...
    "mcp": {
        ...
        "claims": [
            {"scheme_id": "std/mcp-v1", "capability": "tools:call",
             ...
             "rationale": "read files under /workspace only"},
        ],
        "cases": [
            ("M1 read_file in-prefix", "POST", "/mcp",
             {"jsonrpc": "2.0", "id": 1, "method": "tools/call",
              "params": {"name": "read_file", "arguments": {"path": "/workspace/src/a.txt"}}}, 200),
            ("M2 read_file outside prefix", "POST", "/mcp",
             {"jsonrpc": "2.0", "id": 2, "method": "tools/call",
              "params": {"name": "read_file", "arguments": {"path": "/etc/shadow"}}}, 403),
            ("M3 bash not allowlisted", "POST", "/mcp",
             {"jsonrpc": "2.0", "id": 3, "method": "tools/call",
              "params": {"name": "bash", "arguments": {"cmd": "rm -rf /"}}}, 403),
            ("M4 list_dir class grant", "POST", "/mcp",
             {"jsonrpc": "2.0", "id": 4, "method": "tools/call",
              "params": {"name": "list_dir", "arguments": {"path": "/etc"}}}, 200),
            ("M5 delete_file not allowlisted", "POST", "/mcp",
             {"jsonrpc": "2.0", "id": 5, "method": "tools/call",
              "params": {"name": "delete_file", "arguments": {"path": "/a"}}}, 403),
            ("M6 initialize protocol", "POST", "/mcp",
             {"jsonrpc": "2.0", "id": 6, "method": "initialize", "params": {}}, 200),
        ],
    },
}
